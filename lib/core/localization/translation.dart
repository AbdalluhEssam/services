...
class MyTranslation extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
        "ar": {
          ...
          "welcomeglus": "مرحبا بكم فى Service",
          "signupmass":
              "شكرًا على انضمامك إلى عائلة Service نتمنى لك يومًا سعيدًا",
          "logout": "تسجيل الخروج",
          "abouttextglus":
...
""",
        ...
        "en": {
          ...
          "welcomeglus": "Welcome To Service Family",
          "signupmass": "Thank you for joining Service Family Have a nice day",
          "logout": "Log Out",
          "abouttextglus":
